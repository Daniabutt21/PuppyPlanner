...
def custom_openapi():
  ...
  description = \
    """PuppyPlanner is a web app for tracking reminders.
  ...
  openapi_schema = get_openapi(
    title="PuppyPlanner: The Reminders App",
    version="1.0.0",
    ...
    tags=[
      ...
      {
        "name": "Pages",
        "description": "The main PuppyPlanner web pages.",
      },
      {
        "name": "Authentication",
  ...
  openapi_schema["info"]["x-logo"] = {
    "url": "static/img/logos/pupplyplanner-500px.png"
  }
